...
<!-- BDP: name -->
<tr>
   <td colspan="2"><a href="#" id="basic-fields" class='adm-href'><img src="/img/admin_icons/text-fields.png">&nbsp;&nbsp;Основные поля</a></td>
</tr>
<tr class="basic-fields">
...
<!-- BDP: section_pic -->
<tr style="width:500px;">
   <td colspan="2"><a href="#" id="photo" class='adm-href'><img src="/img/admin_icons/img.png">&nbsp;&nbsp;Изображение </a></td>
</tr>
<tr class="photo">
    ...
    <table class="adm-gallery">
		...
		<tr>
    		<td>
    			...
    			<tr><td>Подпись (title):</td><td> <input type="text" name="catalog_upload_title1"  style="width:200px;" > </td></tr>
    			<tr><td>Альтерн. текст  (alt):</td><td> <input type="text" name="catalog_upload_alt1" style="width:200px;"></td></tr>
    		...
    		<td>
    			...
    			<tr><td>Подпись (title):</td><td> <input type="text" name="catalog_upload_title2" style="width:200px;"></td></tr>
    			<tr><td>Альтерн. текст  (alt):</td><td> <input type="text" name="catalog_upload_alt2" style="width:200px;"></td></tr>
		...
		<tr>
    		<td>
    			...
    			<tr><td>Подпись (title):</td><td> <input type="text" name="catalog_upload_title3" style="width:200px;"></td></tr>
    			<tr><td>Альтерн. текст  (alt):</td><td> <input type="text" name="catalog_upload_alt3" style="width:200px;"></td></tr>
    			</table>
    		</td>
    		...
    		<td>
    			...
    			<tr><td>Подпись (title):</td><td> <input type="text" name="catalog_upload_title4" style="width:200px;"></td></tr>
    			<tr><td>Альтерн. текст  (alt):</td><td> <input type="text" name="catalog_upload_alt4" style="width:200px;"></td></tr>
    			</table>
    		</td>
		...
		<tr>	
    		<td>
    			...
    			<tr><td>Подпись (title):</td><td> <input type="text" name="catalog_upload_title5" style="width:200px;"></td></tr>
    			<tr><td>Альтерн. текст  (alt):</td><td> <input type="text" name="catalog_upload_alt5" style="width:200px;"></td></tr>
    			</table>
    		</td>
    		...
    		<td>
    			...
    			<tr><td>Подпись (title):</td><td> <input type="text" name="catalog_upload_title6" style="width:200px;"></td></tr>
    			<tr><td>Альтерн. текст  (alt):</td><td> <input type="text" name="catalog_upload_alt6" style="width:200px;"></td></tr>
    			</table>
    		</td>
    ...
    <table class="adm-gallery">
		...
		<tr>
    		<td>
    			...
    			<tr><td>Подпись (title):</td><td> <input type="text" name="gallery_title1"  style="width:200px;"></td></tr>
    			<tr><td>Альтерн. текст  (alt):</td><td> <input type="text" name="gallery_alt1" style="width:200px;"></td></tr>
    		...
    		<td>
    			...
    			<tr><td>Подпись (title):</td><td> <input type="text" name="gallery_title2" style="width:200px;"></td></tr>
    			<tr><td>Альтерн. текст  (alt):</td><td> <input type="text" name="gallery_alt2" style="width:200px;"></td></tr>
		...
		<tr>
    		<td>
    			...
    			<tr><td>Подпись (title):</td><td> <input type="text" name="gallery_title3" style="width:200px;"></td></tr>
    			<tr><td>Альтерн. текст  (alt):</td><td> <input type="text" name="gallery_alt3" style="width:200px;"></td></tr>
    			</table>
    		</td>
    		...
    		<td>
    			...
    			<tr><td>Подпись (title):</td><td> <input type="text" name="gallery_title4" style="width:200px;"></td></tr>
    			<tr><td>Альтерн. текст  (alt):</td><td> <input type="text" name="gallery_alt4" style="width:200px;"></td></tr>
    			</table>
    		</td>
		...
		<tr>	
    		<td>
    			...
    			<tr><td>Подпись (title):</td><td> <input type="text" name="gallery_title5" style="width:200px;"></td></tr>
    			<tr><td>Альтерн. текст  (alt):</td><td> <input type="text" name="gallery_alt5" style="width:200px;"></td></tr>
    			</table>
    		</td>
    		...
    		<td>
    			...
    			<tr><td>Подпись (title):</td><td> <input type="text" name="gallery_title6" style="width:200px;"></td></tr>
    			<tr><td>Альтерн. текст  (alt):</td><td> <input type="text" name="gallery_alt6" style="width:200px;"></td></tr>
    			</table>
    		</td>
   ...
   Добавить картинки
		...
		<tr>
    		<td>
    			...
    			<tr><td>Подпись (title):</td><td> <input type="text" name="gallery_foreshortening_text1" style="width:200px;"></td></tr>
    			<tr><td>Альтерн. текст  (alt):</td><td> <input type="text" name="gallery_foreshortening_alt1"  style="width:200px;"></td></tr>
    		...
    		<td>
    			...
    			<tr><td>Подпись (title):</td><td> <input type="text" name="gallery_foreshortening_text2"  style="width:200px;"></td></tr>
    			<tr><td>Альтерн. текст  (alt):</td><td> <input type="text" name="gallery_foreshortening_alt2" style="width:200px;"></td></tr>
		...
		<tr>
    		<td>
    			...
    			<tr><td>Подпись (title):</td><td> <input type="text" name="gallery_foreshortening_text3" style="width:200px;"></td></tr>
    			<tr><td>Альтерн. текст  (alt):</td><td> <input type="text" name="gallery_foreshortening_alt3" style="width:200px;"></td></tr>
    			</table>
    		</td>
    		...
    		<td>
    			...
    			<tr><td>Подпись (title):</td><td> <input type="text" name="gallery_foreshortening_text4" style="width:200px;"></td></tr>
    			<tr><td>Альтерн. текст  (alt):</td><td> <input type="text" name="gallery_foreshortening_alt4" style="width:200px;"></td></tr>
    			</table>
    		</td>
		...
		<tr>	
    		<td>
    			...
    			<tr><td>Подпись (title):</td><td> <input type="text" name="gallery_works_text5" style="width:200px;"></td></tr>
    			<tr><td>Альтерн. текст  (alt):</td><td> <input type="text" name="gallery_foreshortening_alt5" style="width:200px;"></td></tr>
    			</table>
    		</td>
    		...
    		<td>
    			...
    			<tr><td>Подпись (title):</td><td> <input type="text" name="gallery_foreshortening_text6" style="width:200px;" ></td></tr>
    			<tr><td>Альтерн. текст  (alt):</td><td> <input type="text" name="gallery_foreshortening_alt6"  style="width:200px;"></td></tr>
    			</table>
    		</td>
...
<!-- BDP: used_complete -->
<tr>
   <td colspan="2"><a href="#" id="description" class='adm-href'><img src="/img/admin_icons/insert-text.png">&nbsp;&nbsp;Описания / Комплект</a></td>
</tr>
