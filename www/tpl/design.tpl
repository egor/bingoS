...
var _gaq = _gaq || [];
_gaq.push(['_setAccount', 'UA-13286800-16']);
...
var s = document.getElementsByTagName('script')[0]; s[removed].insertBefore(ga, s);
    ...
    <div class="wrap_main">
    	<div id="header">
            <!-- BDP: main_logo_text -->
            <span class="logo"><img src="/img/bg_header_logo.gif" alt="{LOGOALT}" title="{LOGOALT}" /></span>
            <!-- EDP: main_logo_text -->

            <!-- BDP: main_logo_url -->
            <a class="logo" href="/" title="{LOGOALT}"><img src="/img/bg_header_logo.gif" alt="{LOGOALT}" title="{LOGOALT}" /></a>
            <!-- EDP: main_logo_url -->
        ...
        <div class="footer_banners">
            ...
            <div class="right">
                <a href="#" title="" class="bingo" target="_blank">
                   <img src="/img/bingo.gif" alt="" class="img" />
                   <br />создание сайтов
                </a>
            </div>
        </div>
